...
def model_fn(features, labels, mode, params):
    ...
    with tf.device(GPU['titan']):
        ...
        # with tf.variable_scope('end_predictor'):
        #     with tf.variable_scope('end_transformer_layer_1'):
        #         end_transformed = multihead_attention(transformer_input, params['batch_size'], seq_length=params['input_max_length'], num_heads=8, size_per_head=64)
        #     with tf.variable_scope('end_transformer_layer_2'):
        #         end_transformed = multihead_attention(end_transformed, params['batch_size'], seq_length=params['input_max_length'], num_heads=8, size_per_head=64)
